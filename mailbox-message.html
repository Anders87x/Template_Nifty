...
<head>
    ...
    <title>View Message | Nifty - Admin Template</title>
					                    ...
					                    <div class="pad-ver">
					                        ...
					                        <ul class="mail-attach-list list-ov">
					                            <li>
					                                <a href="#" class="thumbnail">
					                                    <div class="mail-file-img">
					                                        <img class="image-responsive" src="img\bg-img\bg-img-4.jpeg" alt="image">
					                                    </div>
					                                    <div class="caption">
					                            ...
					                            <li>
					                                <a href="#" class="thumbnail">
					                                    <div class="mail-file-img">
					                                        <img class="image-responsive" src="img\bg-img\bg-img-3.jpeg" alt="image">
					                                    </div>
					                                    <div class="caption">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="mailbox-message.html">View Message</a></li>
