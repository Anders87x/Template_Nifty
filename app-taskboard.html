...
<head>
    ...
    <title>Taskboard | Nifty - Admin Template</title>
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <div class="text-center pad-btm">
                        <h3>Taskboard <a href="#" class="btn-link text-thin">Project #68</a></h3>
                        <p>You have option as well to <strong class="text-main">drag tasks</strong> from a list <strong class="text-main">and drop</strong> them directly onto a task list name.</p>
                    </div>
                    <!---------------------------------->
                </div>
                ...
                <div id="page-content">
					    ...
					    <div class="row">
					        <div class="col-sm-4">
					            ...
					            <!---------------------------------->
					            <div>
					                <a href="#" class="pull-right btn btn-info btn-sm">Add New</a>
					                <h4 class="text-main">Upcoming</h4>
					                ...
					                <ul id="demo-tasklist-upcoming" class="sortable-list tasklist list-unstyled">
					                    <li id="demo-tasklist-1" class="task-warning">
					                    ...
					                    <li id="demo-tasklist-2" class="task-info">
					                        ...
					                        <p class="pad-btm bord-btm">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
					                        <a href="#" class="task-footer">
					                            <span class="box-inline">
					                    ...
					                    <li id="demo-tasklist-4" class="task-danger">
					                        <p class="text-bold text-main text-sm">#345456</p>
					                        <p class="pad-btm bord-btm">The new common language will be more simple and regular than the existing European languages.</p>
					                        <a href="#" class="task-footer">
					                            <span class="box-inline">
					                                <img class="img-xs img-circle" src="img\profile-photos\7.png" alt="task-user">
					                                Brenda Fuller
					                            </span>
					                        </a>
					                    </li>
					        ...
					        <div class="col-sm-4">
					            ...
					            <div>
					                ...
					                <ul id="demo-tasklist-inprogress" class="sortable-list tasklist list-unstyled">
					                    ...
					                    <li id="demo-tasklist-6" class="task-success">
					                    ...
					                    <li id="demo-tasklist-8" class="task-danger">
					        ...
					        <div class="col-sm-4">
					            ...
					            <div>
					                ...
					                <ul id="demo-tasklist-completed" class="sortable-list tasklist list-unstyled">
					                    ...
					                    <li id="demo-tasklist-10" class="task-warning">
					                        <p class="text-bold text-main text-sm">#54686</p>
					                        <p class="pad-btm bord-btm">The European languages are members of the same family. Their separate existence is a myth.</p>
					                        <a href="#" class="task-footer">
					                            <span class="box-inline">
					                    ...
					                    <li id="demo-tasklist-11" class="task-info">
					                        <p class="text-bold text-main text-sm">#68464</p>
					                        <p class="pad-btm bord-btm">To achieve this, it would be necessary to have uniform grammar, pronunciation and more common words. </p>
					                        <a href="#" class="task-footer">
					                            <span class="box-inline">
					                    ...
					                    <li id="demo-tasklist-12" class="task-success">
					                        ...
					                        <img class="img-responsive mar-btm" src="img\shared-img.jpeg" alt="Image">
					                        <p class="pad-btm bord-btm">No one rejects, dislikes, or avoids pleasure itself, because it is pleasure.</p>
					                        <a href="#" class="task-footer">
					                            <span class="box-inline">
					                                <span class="pad-rgt"><i class="demo-pli-heart-2"></i> 54K</span>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="app-taskboard.html">Taskboard</a></li>
