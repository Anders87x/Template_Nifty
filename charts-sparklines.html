...
<head>
    ...
    <title>Sparklines | Nifty - Admin Template</title>
...
<body>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Sparklines</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					        ...
					        <div class="col-md-4">
					            <div class="panel">
					                ...
					                <div class="pad-all">
					                    ...
					                    <!--Sparklines Area-->
					                    <!--===================================================-->
					                    <div id="demo-sparklines-area-1"></div>
					                    <!--===================================================-->
					                    <!-- End Sparklines Area -->
					        ...
					        <div class="col-md-4">
					            <div class="panel">
					                ...
					                <div class="pad-all">
					                    ...
					                    <!--Sparklines Line-->
					                    <!--===================================================-->
					                    <div id="demo-sparklines-line-1"></div>
					                    <!--===================================================-->
					                    <!-- End Sparklines Line -->
					        ...
					        <div class="col-md-4">
					            <div class="panel">
					                ...
					                <div class="pad-all">
					                    ...
					                    <!--Sparklines Bar-->
					                    <!--===================================================-->
					                    <div id="demo-sparklines-bar-1" class="sparklines-bar"></div>
					                    <!--===================================================-->
					                    <!-- End Sparklines Bar -->
					    ...
					    <div class="row">
					        <div class="col-md-4">
					            <div class="panel panel-info panel-colorful">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Area Full</h3>
					                </div>
					                <div class="panel-body">
					
					                    <!--Sparklines Area Full-->
					                    <!--===================================================-->
					                    <div id="demo-sparklines-area-2" class="sparklines-full-content"></div>
					                    <!--===================================================-->
					                    <!-- End Sparklines Area Full -->
					        ...
					        <div class="col-md-4">
					            <div class="panel panel-success panel-colorful">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Line Full</h3>
					                </div>
					                <div class="panel-body">
					
					                    <!--Sparklines Line Full-->
					                    <!--===================================================-->
					                    <div id="demo-sparklines-line-2" class="sparklines-full-content"></div>
					                    <!--===================================================-->
					                    <!-- End Sparklines Line Full -->
					        ...
					        <div class="col-md-4">
					            ...
					            <div class="panel panel-warning panel-colorful">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Bar Full</h3>
					                </div>
					                <div class="panel-body">
					
					                    <!--Sparklines Bar Full-->
					                    <!--===================================================-->
					                    <div id="demo-sparklines-bar-2" class="sparklines-bar sparklines-full-content"></div>
					                    <!--===================================================-->
					                    <!-- End Sparklines Bar Full -->
					                    ...
					                    <table class="table table-striped">
					                        <tbody>
					                            <tr>
					                                <td>Line graphs</td>
					                                <td class="text-right">
					                                    <span class="demo-sparkline">8,4,0,0,0,0,1,4,4,10,10,10,10,0,0,0,4,6,5,9,10</span>
					                                </td>
					                            </tr>
					                            <tr>
					                                <td>Bar chart</td>
					                                <td class="text-right">
					                                    <span class="demo-sparkbar">10,8,9,3,5,8,5</span>
					                                </td>
					                            </tr>
					                            <tr>
					                                <td>Stacked</td>
					                                <td class="text-right">
					                                    <span class="demo-sparkbar">0:2,2:4,4:2,4:1</span>
					                                </td>
					                            </tr>
					                            <tr>
					                                <td>Negative values</td>
					                                <td class="text-right">
					                                    <span class="demo-sparkbar">-3,1,2,0,3,-1</span>
					                                </td>
					                            </tr>
					                            <tr>
					                                <td>Composite inline</td>
					                                <td class="text-right">
					                                    <span id="demo-compositeline">8,4,0,0,0,0,1,4,4,10,10,10,10,0,0,0,4,6,5,9,10</span>
					                                </td>
					                            </tr>
					                            ...
					                            <tr>
					                                ...
					                                <td class="text-right">
					                                    <span id="demo-normalline">8,4,0,0,0,0,1,4,4,10,10,10,10,0,0,0,4,6,5,9,10</span>
					                                </td>
					                            </tr>
					                            <tr>
					                                <td>Composite bar</td>
					                                <td class="text-right">
					                                    <span id="demo-compositebar">4,6,7,7,4,3,2,1,4</span>
					                                </td>
					                            </tr>
					                        </tbody>
					                    </table>
					                    ...
					                    <table class="table table-striped">
					                        <tbody>
					                            <tr>
					                                <td>Discrete</td>
					                                <td class="text-right">
					                                    <span id="demo-discrete1">4,6,7,7,4,3,2,1,4,4,5,6,7,6,6,2,4,5</span>
					                                </td>
					                            </tr>
					                            ...
					                            <tr>
					                                ...
					                                <td class="text-right">
					                                    <span id="demo-discrete2">4,6,7,7,4,3,2,1,4</span>
					                                </td>
					                            </tr>
					                            ...
					                            <tr>
					                                ...
					                                <td class="text-right">
					                                    <span id="demo-linecustom">10,8,9,3,5,8,5,7</span>
					                                </td>
					                            </tr>
					                            ...
					                            <tr>
					                                ...
					                                <td class="text-right">
					                                    <span id="demo-sparktristate">1,1,0,1,-1,-1,1,-1,0,0,1,1</span>
					                                </td>
					                            </tr>
					
					                            <tr>
					                                <td>Tristate chart using a color map</td>
					                                <td class="text-right">
					                                    <span id="demo-sparktristatecols">1,2,0,2,-1,-2,1,-2,0,0,1,1</span>
					                                </td>
					                            </tr>
					                            ...
					                            <tr>
					                                <td>Pie charts</td>
					                                <td class="text-right">
					                                    <span class="demo-sparkpie">1,1,2</span>
					                                    <span class="demo-sparkpie">1,5</span>
					                                    <span class="demo-sparkpie">20,50,80</span>
					                                </td>
					                            </tr>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="charts-sparklines.html">Sparklines</a></li>
    ...
    <!--Sparklines Demo [ SAMPLE ]-->
    <script src="js\demo\sparklines.js"></script>
