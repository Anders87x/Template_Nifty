...
<head>
    ...
    <title>Flot Charts | Nifty - Admin Template</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Flot Charts</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                ...
                <div id="page-content">
					    ...
					    <div class="row">
					        <div class="col-md-6">
					            ...
					            <div class="panel">
					                ...
					                <div class="pad-all">
					                    <div id="demo-flot-area" class="legendInline" style="height:250px"></div>
					                </div>
					            </div>
					            <!---------------------------------->
					    ...
					    <div class="row">
					        <div class="col-md-6">
					            ...
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Full Content Chart</h3>
					                </div>
					                <div class="panel-body">
					                    <div id="demo-flot-area-full" class="flot-full-content" style="height: 305px"></div>
					                </div>
					            </div>
					            <!---------------------------------->
					    ...
					    <div class="panel">
					        ...
					        <div class="panel-body">
					            <div id="demo-flot-realtime" style="height: 250px"></div>
					        </div>
					    </div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="charts-flot-charts.html">Flot Charts</a></li>
