...
<head>
    ...
    <title>Spinkit | Nifty - Admin Template</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Spinkit</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                ...
                <div id="page-content">
					    ...
					    <div class="row spinner-example">
					        ...
					        <div class="col-sm-6 col-md-4 col-lg-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Rotate Plane</h3>
					                </div>
					                <div class="panel-body">
					        ...
					        <div class="col-sm-6 col-md-4 col-lg-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Double Bounce</h3>
					                </div>
					                <div class="panel-body">
					        ...
					        <div class="col-sm-6 col-md-4 col-lg-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Wandering Cubes</h3>
					                </div>
					                <div class="panel-body">
					        ...
					        <div class="col-sm-6 col-md-4 col-lg-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Chasing Dots</h3>
					                </div>
					                <div class="panel-body">
					        ...
					        <div class="col-sm-6 col-md-4 col-lg-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Three Bounce</h3>
					                </div>
					                <div class="panel-body">
					        ...
					        <div class="col-sm-6 col-md-4 col-lg-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Circle</h3>
					                </div>
					                <div class="panel-body">
					                    <div class="sk-circle">
					        ...
					        <div class="col-sm-6 col-md-4 col-lg-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Cube Grid</h3>
					                </div>
					                <div class="panel-body">
					        ...
					        <div class="col-sm-6 col-md-4 col-lg-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Fading Circle</h3>
					                </div>
					                <div class="panel-body">
					        ...
					        <div class="col-sm-6 col-md-4 col-lg-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Folding Cube</h3>
					                </div>
					                <div class="panel-body">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="misc-spinkit.html">Spinkit</a></li>
