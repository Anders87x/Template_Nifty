...
<head>
    ...
    <title>Masonry | Nifty - Admin Template</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Masonry</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                ...
                <div id="page-content">
					    ...
					    <div class="grid">
					        ...
					        <div class="grid-item">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">I must explain to you</h3>
					                </div>
					                <div class="pad-all">
					        ...
					        <div class="grid-item">
					            <div class="panel panel-colorful panel-mint">
					                <div class="panel-heading">
					                    <h3 class="panel-title">A wonderful serenity</h3>
					                </div>
					                <div class="pad-all">
					        ...
					        <div class="grid-item">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">One morning</h3>
					                </div>
					                <div class="pad-all">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="grid-masonry.html">Masonry</a></li>
