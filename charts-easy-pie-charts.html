...
<head>
    ...
    <title>Easy Pie Charts | Nifty - Admin Template</title>
...
<body>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Easy Pie Charts</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                ...
                <div id="page-content">
					    ...
					    <div class="row text-center">
					        <div class="col-md-3">
					            <div class="panel">
					                ...
					                <div class="panel-body">
					                    ...
					                    <!--Rounded-->
					                    <!--===================================================-->
					                    <div id="demo-pie-1" class="demo-pie" data-percent="35"></div>
					                    <!--===================================================-->
					                    <!-- End Rounded -->
					        ...
					        <div class="col-md-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Square</h3>
					                </div>
					                <div class="panel-body">
					
					                    <!--Square-->
					                    <!--===================================================-->
					                    <div id="demo-pie-2" class="demo-pie" data-percent="67"></div>
					                    <!--===================================================-->
					                    <!-- End Square -->
					        ...
					        <div class="col-md-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Thin</h3>
					                </div>
					                <div class="panel-body">
					
					                    <!--Thin-->
					                    <!--===================================================-->
					                    <div id="demo-pie-3" class="demo-pie" data-percent="78"></div>
					                    <!--===================================================-->
					                    <!-- End Thin -->
					        ...
					        <div class="col-md-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Thick</h3>
					                </div>
					                <div class="panel-body">
					
					                    <!--Thick-->
					                    <!--===================================================-->
					                    <div id="demo-pie-4" class="demo-pie" data-percent="45"></div>
					                    <!--===================================================-->
					                    <!-- End Thick -->
					        ...
					        <div class="col-md-3">
					            <div class="panel">
					                ...
					                <div class="panel-body">
					                    ...
					                    <!--Large-->
					                    <!--===================================================-->
					                    <div id="demo-pie-5" class="demo-pie" data-percent="65"></div>
					                    <!--===================================================-->
					                    <!-- End Large -->
					        ...
					        <div class="col-md-3">
					            <div class="panel">
					                ...
					                <div class="panel-body">
					                    ...
					                    <!--Scale-->
					                    <!--===================================================-->
					                    <div id="demo-pie-6" class="demo-pie" data-percent="69"></div>
					                    <!--===================================================-->
					                    <!-- End Scale -->
					        ...
					        <div class="col-md-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Data Percent</h3>
					                </div>
					                <div class="panel-body">
					
					                    <!--Data Percent-->
					                    <!--===================================================-->
					                    <div id="demo-pie-7" class="demo-pie pie-title-center" data-percent="39">
					        ...
					        <div class="col-md-3">
					            <div class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Custom Data</h3>
					                </div>
					                <div class="panel-body">
					
					                    <!--Custom Data-->
					                    <!--===================================================-->
					                    <div id="demo-pie-8" class="demo-pie pie-title-center" data-percent="50">
					    ...
					    <div class="panel">
					        <div class="panel-body">
					            <button id="demo-update-interval" class="btn btn-block btn-lg btn-primary">Update Chart Value</button>
					        </div>
					    </div>
					    ...
					    <div class="row">
					        <div class="col-md-6">
					            <div class="panel">
					                ...
					                <div class="panel-body">
					                    <p>You can pass these options to the initialize function to set a custom look and feel for the plugin.</p>
					                    <table class="table table-bordered">
					                        <tbody>
					                            ...
					                            <tr>
					                                ...
					                                <td>defaultEasing</td>
					                                <td>Easing function or string with the name of a <a href="http://gsgd.co.uk/sandbox/jquery/easing/">jQuery easing function</a></td>
					                            </tr>
					                        </tbody>
					                    </table>
					                </div>
					        ...
					        <div class="col-md-6">
					            <div class="panel">
					                ...
					                <div class="panel-body">
					                    <p>All callbacks will only be called if <code>animate</code> is not <code>false</code>.</p>
					                        <table class="table table-bordered">
					                            <tbody><tr>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="charts-easy-pie-charts.html">Easy Pie Charts</a></li>
    ...
    <script src="js\demo\easy-pie-chart.js"></script>
