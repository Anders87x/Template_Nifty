...
<head>
    ...
    <title>Solid Icons Pack | Nifty - Admin Template</title>
...
<body>
    ...
    <div class="pad-all text-center bg-primary">
        <h1 class="text-4x text-semibold">Premium Solid Icons</h1>
        <p class="pad-btm">Discover our high quality premium icons, availables in solid and line style.</p>


        <hr class="new-section-sm bord-no">
        <p class="h1 text-5x text-bold"><span class="badge badge-danger">2100+</span></p>
        <p class="text-lg text-uppercase text-bold text-main">Free Solid icons in 53 categories</p>
        <p>The icon pack is organized into 53 categories and  each icon comes in two different styles: solid and line.<br> With two different icon styles, you are basically getting over 4,200+ icons.</p>
        <hr class="new-section-md bord-no">

        <img src="premium\solid-icons-header.png">
        <div class="text-2x"><i class="pci-chevron chevron-down"></i></div>
    </div>                </div>
                ...
                <div id="page-content">
					...
					<div class="panel">
					    ...
					    <div class="panel-body text-center">
					        <h4 class="pad-top">Alignment &amp; Paragraph</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\alignment.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Animals</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\animals.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Arrow View</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\arrow-view.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Arrows</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\arrows.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Body Parts</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\body.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Browsers &amp; Operating Systems</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\browser.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Buildings &amp; Landmarks</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\building.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Business &amp; Finance</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\business.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Chess</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\chess.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Christmas</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\christmas.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Clothes &amp; Accessories</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\clothes.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Cloud</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\clouds.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Communications &amp; Network</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\communications.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Database</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\database.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Design</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\design.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Desktop Apps</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\desktop.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Education</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\education.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Emails</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\emails.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Emoticons</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\emoticons.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Files</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\files.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Folders</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\folders.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Food &amp; Drinks</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\food.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Flags</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\flags.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Halloween</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\halloween.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Hardware</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\hardware.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Hipster Style</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\hipster.png">
					
					
					        <h4 class="pad-top">Industry</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\industry.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Interface</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\interface.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Logos</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\logos.png">
					        <hr class="new-section-md bord-no">
					        ...
					        <h4 class="pad-top">Maps and Locations</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\maps.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Media Control</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\media-control.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Music</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\music.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Nature </h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\nature.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Objects </h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\object.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Peoples </h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\people.png">
					        <hr class="new-section-md bord-no">
					
					       <h4 class="pad-top">Photos</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\photos.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Science &amp; Medical</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\science-medical.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Security</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\security.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Seo Icons</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\seo.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Shopping &amp; E-commerce</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\security.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Signs &amp; Symbols</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\sign-symbols.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Social Media</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\social-media.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Speech Bubbles</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\speech-bubbles.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Sports</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\sports.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Text</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\text.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Time</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\time.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Touch Gestures</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\touch.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Transportations</h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\security.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">User Interface <span class="text-xs"><label class="badge badge-primary">New</label></span></h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\ui.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Video <span class="text-xs"><label class="badge badge-primary">New</label></span></h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\video.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Weather <span class="text-xs"><label class="badge badge-primary">New</label></span></h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\weather.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Windows <span class="text-xs"><label class="badge badge-primary">New</label></span></h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\windows.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Zodiac <span class="text-xs"><label class="badge badge-primary">New</label></span></h4>
					        <img src="premium\icon-sets\thumbs\solid-icons\zodiac.png">
					        <hr class="new-section-md bord-no">
					    </div>
					</div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="premium-solid-icons.html">Solid Icons Pack</a></li>
