...
<head>
    ...
    <title>Pricing Table | Nifty - Admin Template</title>
...
<body>
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="text-center">
            ...
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. <br>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
        </div>
        <hr class="new-section-md bord-no">
                ...
                <div id="page-content">
					    ...
					    <div class="row">
					        <div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
					            <div class="row pricing pricing-no-gutter-sm">
					                ...
					                <div class="col-sm-4">
					                    <div class="panel">
					                        <div class="panel-body">
					                            ...
					                            <p class="pricing-desc">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
					                            <div class="pricing-price">
					                                <p><span class="text-semibold text-primary">$19</span></p>
					                                <p>Monthly</p>
					                            </div>
					                ...
					                <!--Premium Plan-->
					                <!--===================================================-->
					                <div class="col-sm-4 pricing-featured">
					                    <div class="panel">
					                        ...
					                        <div class="panel-body">
					                            ...
					                            <p class="pricing-desc">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
					                            <div class="pricing-price">
					                                <p><span class="text-semibold text-success">$39</span></p>
					                                <p>Monthly</p>
					                            </div>
					                            <ul class="pricing-list">
					                ...
					                <div class="col-sm-4">
					                    <div class="panel">
					                        <div class="panel-body">
					                            ...
					                            <p class="pricing-desc">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
					                            <div class="pricing-price">
					                                <p><span class="text-semibold text-purple">$99</span></p>
					                                <p>Monthly</p>
					                            </div>
					                            <ul class="pricing-list">
					    ...
					    <hr class="new-section-md bord-no">
					    <h3 class="text-center">4 columns</h3>
					    <div class="row pricing">
					            ...
					            <div class="panel">
					                <div class="panel-body">
					                    ...
					                    <ul class="pricing-list">
					                        ...
					                        <li><strong>2</strong> GB Storage</li>
					                        <li><strong>1</strong> User</li>
					                        <li><strong>No</strong> Support</li>
					                    </ul>
					                    <button class="btn btn-block btn-purple">Choose</button>
					                </div>
					            </div>
					        </div>
					        <!--===================================================-->
					    ...
					    <hr class="new-section-md bord-no">
					    <div class="row pricing pricing-no-gutter">
					        ...
					        <div class="col-sm-6 col-md-3">
					            <div class="panel">
					                <div class="panel-body">
					                    ...
					                    <p class="pricing-desc">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
					                    <div class="pricing-price">
					                        <p><span class="text-semibold text-mint">$0</span></p>
					                        <p>Monthly</p>
					                    </div>
					                    <ul class="pricing-list">
					                        <li><strong>1</strong> Projects</li>
					        ...
					        <!--Premium Plan-->
					        <!--===================================================-->
					        <div class="col-sm-6 col-md-3 pricing-featured">
					            <div class="panel">
					                <div class="ribbon"><span>POPULAR</span></div>
					                <div class="panel-body">
					                    <p class="pricing-title">Premium</p>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="pages-pricing.html">Pricing<span class="label label-success pull-right">New</span></a></li>
											<li class="list-divider"></li>
