...
<head>
    ...
    <title>Timeline | Nifty - Admin Template</title>
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <div class="text-center pad-btm">
                        <h3>Timeline</h3>
                        <p>Super Simple Responsive Timeline.</p>
                    </div>
                    <hr class="new-section-sm bord-no">
                    <!---------------------------------->
                </div>
					    ...
					    <div class="col-lg-5">
					        ...
					        <div class="timeline">
					            ...
					            <div class="timeline-entry">
					                ...
					                <div class="timeline-label">
					                    <img class="img-xs img-circle" src="img\profile-photos\2.png" alt="Profile picture">
					...
					<div class="row">
					    <div class="col-lg-5">
					        ...
					        <div class="timeline">
					            ...
					            <div class="timeline-entry">
					                <div class="timeline-stat">
					                    <div class="timeline-icon"><img src="img\profile-photos\9.png" alt="Image"></div>
					                    <div class="timeline-time">3 Hours ago</div>
					                </div>
					                <div class="timeline-label">
					                    <p class="mar-no pad-btm"><a href="#" class="btn-link">Lisa D.</a> commented on <a href="#" class="text-semibold"><i>The Article.</i></a></p>
					            ...
					            <div class="timeline-entry">
					                <div class="timeline-stat">
					                    <div class="timeline-icon"><img src="img\profile-photos\3.png" alt="Image"></div>
					                    <div class="timeline-time">15:45</div>
					                </div>
					                <div class="timeline-label">
					                    <p class="text-main text-semibold">Lorem ipsum dolor sit amet</p>
					            ...
					            <div class="timeline-entry">
					                <div class="timeline-stat">
					                    <div class="timeline-icon"><img src="img\profile-photos\2.png" alt="Image"></div>
					                    <div class="timeline-time">13:27</div>
					                </div>
					                <div class="timeline-label">
					                    <a href="#" class="btn-link">Michael Both</a> Like <a href="#" class="text-semibold"><i>The Article.</i></a>
					            ...
					            <div class="timeline-entry">
					                <div class="timeline-stat">
					                    <div class="timeline-icon"><img src="img\thumbs\img1.jpeg" alt="Image"></div>
					                    <div class="timeline-time">11:27</div>
					                </div>
					                <div class="timeline-label">
					                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt.
					    ...
					    <div class="col-lg-5 col-lg-offset-2">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Timeline inside the panel</h3>
					            </div>
					            <div class="panel-body">
					                ...
					                <div class="timeline">
					                    ...
					                    <div class="timeline-entry">
					                        <div class="timeline-stat">
					                            <div class="timeline-icon bg-info"><i class="demo-psi-twitter icon-lg"></i></div>
					                            <div class="timeline-time">5 Hours ago</div>
					                        </div>
					                        <div class="timeline-label">
					                            <img class="img-xs img-circle" src="img\profile-photos\3.png" alt="Profile picture">
					                            <a href="#" class="btn-link">Bobby Marz</a> followed you.
					                        </div>
					                    </div>
					                    <div class="timeline-entry">
					                        <div class="timeline-stat">
					    ...
					    <div class="timeline-entry">
					        ...
					        <div class="timeline-label">
					            ...
					            <div class="img-holder">
					                <img alt="Image" src="img\thumbs\img2.jpeg">
					            </div>
					        </div>
					    </div>
					    <div class="timeline-entry">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
						                    <li class="active-link"><a href="misc-timeline.html">Timeline</a></li>
