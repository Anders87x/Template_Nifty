...
<head>
    ...
    <title>Default Theme | Nifty - Admin Template</title>
	...
	<link href="plugins\unitegallery\themes\default\ug-theme-default.css" rel="stylesheet">
...
<body>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Default Theme</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					...
					<li class="active">Default Theme</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                ...
                <div id="page-content">
					...
					<div class="row">
					    <div class="col-lg-6">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Default theme</h3>
					            </div>
					            <div class="pad-all">
					                <div id="demo-gallery" style="display:none;">
					
					                    <a href="#">
					                        <img alt="The winding road" src="img\gallery\thumbs\tile1.jpeg" data-image="img/gallery/big/tile1.jpg" data-description="The winding road description" style="display:none">
					                    </a>
					
					                    <a href="#">
					                        <img alt="Pancake" src="img\gallery\thumbs\tile2.jpeg" data-image="img/gallery/big/tile2.jpg" data-description="A pancake is a flat cake, often thin and round, prepared from a starch-based batter" style="display:none">
					                    </a>
					
					                    <a href="#">
					                        <img alt="Foreshore" src="img\gallery\thumbs\tile3.jpeg" data-image="img/gallery/big/tile3.jpg" data-description="The part of a shore between high- and low-water marks, or between the water and cultivated or developed land." style="display:none">
					                    </a>
					
					                    <a href="#">
					                        <img alt="Yellow Flowers" src="img\gallery\thumbs\tile4.jpeg" data-image="img/gallery/big/tile4.jpg" data-description="Those are yellow flowers" style="display:none">
					                    </a>
					
					                    <a href="#">
					                        <img alt="Waterfall" src="img\gallery\thumbs\tile5.jpeg" data-image="img/gallery/big/tile5.jpg" data-description="A waterfall is a place where water flows over a vertical drop or a series of steep drops in the course of a stream or river." style="display:none">
					                    </a>
					
					                    <a href="#">
					                        <img alt="Pumpkin" src="img\gallery\thumbs\tile6.jpeg" data-image="img/gallery/big/tile6.jpg" data-description="A pumpkin is a cultivar of a squash plant, most commonly of Cucurbita pepo, that is round, with smooth, slightly ribbed skin, and deep yellow to orange coloration." style="display:none">
					                    </a>
					
					                    <a href="#">
					                        <img alt="In the jungle" src="img\gallery\thumbs\tile7.jpeg" data-image="img/gallery/big/tile7.jpg" data-description="This is my car" style="display:none">
					                    </a>
					
					                    <a href="#">
					                        <img alt="Note" src="img\gallery\thumbs\tile8.jpeg" data-image="img/gallery/big/tile8.jpg" data-description="This is a note" style="display:none">
					                    </a>
					
					                    <a href="#">
					                        <img alt="Off-Road Motorcycle" src="img\gallery\thumbs\tile9.jpeg" data-image="img/gallery/big/tile9.jpg" data-description="This is a motorcycle" style="display:none">
					                    </a>
					
					                    <a href="#">
					                        <img alt="Adventure" src="img\gallery\thumbs\tile10.jpeg" data-image="img/gallery/big/tile10.jpg" data-description="River Adventure Camping" style="display:none">
					                    </a>
					    ...
					    <div class="col-lg-6">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Disable title text</h3>
					            </div>
					            <div class="pad-all">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="gallery-default-theme.html">Default Theme</a></li>
	...
	<script src="plugins\unitegallery\themes\default\ug-theme-default.js"></script>
