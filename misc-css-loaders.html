...
<head>
    ...
    <title>CSS Loaders | Nifty - Admin Template</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">CSS Loaders</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					...
					<li class="active">CSS Loaders</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                ...
                <div id="page-content">
					    ...
					    <div class="panel">
					        <div class="panel-body">
					            <h3>Single Element CSS Spinners</h3>
					            <p>This is a collection of loading spinners animated with CSS.<br>The aim of this project was to create a set of minimal loading spinners that are visually appealing and also convey their intended meaning.</p>
					        </div>
					    </div>
					
					    <div class="row css-loader-example">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="misc-css-loaders.html">CSS Loaders</a></li>
