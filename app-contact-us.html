					            ...
					            <div class="row">
					                <div class="col-sm-6">
					                    <form action="#" method="post">
					                        ...
					                        <div class="form-group">
					                            <textarea class="form-control" name="message" rows="10" placeholder="Your message"></textarea>
					                        </div>
					                ...
					                <div class="col-sm-6">
					                    <div class="mar-all">
					                        <div class="media">
					                            ...
					                            <div class="media-body">
					                                <address>
					                                    <strong class="text-main"> My Company, Inc.</strong><br>
					                        ...
					                        <p><i class="icon-lg icon-fw demo-pli-old-telephone"></i> <span>(123) 456-7890</span></p>
					                        <div class="pad-btm">
					                        ...
					                        <div class="pad-ver">
					                            ...
					                            <a href="#" class="mar-rgt box-inline demo-pli-google-plus icon-lg add-tooltip" data-original-title="Google+" data-container="body"></a>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="app-contact-us.html">Contact Us</a></li>
