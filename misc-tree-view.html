...
<head>
    ...
    <title>Tree View | Nifty - Admin Template</title>
    ...
    <!--JSTree [ OPTIONAL ]-->
    <link href="plugins\jstree\themes\default\style.min.css" rel="stylesheet">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Tree View</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                ...
                <div id="page-content">
					    ...
					    <div class="panel">
					        <div class="panel-body">
					            <h3>jsTree</h3>
					            <p>jsTree is jquery plugin, that provides interactive trees, it supports HTML &amp; JSON data sources, AJAX &amp; async callback loading.</p>
					    ...
					    <div class="row">
					        <div class="col-sm-6 col-md-4">
					            ...
					            <div class="panel">
					                 <div class="panel-heading">
					                     <h3 class="panel-title">JSON Example</h3>
					                 </div>
					                 <div class="panel-body">
					        ...
					        <div class="col-sm-6 col-md-8">
					            ...
					            <div class="panel">
					                 <div class="panel-heading">
					                     <h3 class="panel-title">Custom Icon (Premium Line Icons)</h3>
					                 </div>
					                 <div class="panel-body">
					            ...
					            <div class="panel">
					                 <div class="panel-heading">
					                     <h3 class="panel-title">Custom Icon (Premium Solid Icons)</h3>
					                 </div>
					                 <div class="panel-body">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="misc-tree-view.html">Tree View</a></li>
