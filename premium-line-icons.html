...
<head>
    ...
    <title>Line Icons Pack | Nifty - Admin Template</title>
...
<body>
    ...
    <div class="pad-all text-center bg-primary">
        <h1 class="text-4x text-semibold">Premium Line Icons</h1>
        ...
        <p class="text-lg text-uppercase text-bold text-main">Free Line icons in 53 categories</p>
        ...
        <img src="premium\line-icons-header.png">
                ...
                <div id="page-content">
                    <div class="panel">
					    ...
					    <div class="panel-body text-center">
					        ...
					        <img src="premium\icon-sets\thumbs\line-icons\alignment.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Animals</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\animals.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Arrow View</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\arrow-view.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Arrows</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\arrows.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Body Parts</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\body.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Browsers &amp; Operating Systems</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\browser.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Buildings &amp; Landmarks</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\building.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Business &amp; Finance</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\business.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Chess</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\chess.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Christmas</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\christmas.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Clothes &amp; Accessories</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\clothes.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Cloud</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\clouds.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Communications &amp; Network</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\communications.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Database</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\database.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Design</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\design.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Desktop Apps</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\desktop.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Education</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\education.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Emails</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\emails.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Emoticons</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\emoticons.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Files</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\files.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Folders</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\folders.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Food &amp; Drinks</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\food.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Flags</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\flags.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Halloween</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\halloween.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Hardware</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\hardware.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Hipster Style</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\hipster.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Industry</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\industry.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Interface</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\interface.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Logos</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\logos.png">
					        <hr class="new-section-md bord-no">
					        ...
					        <img src="premium\icon-sets\thumbs\line-icons\maps.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Media Control</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\media-control.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Music</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\music.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Nature </h4>
					        <img src="premium\icon-sets\thumbs\line-icons\nature.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Objects</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\object.png">
					        <hr class="new-section-md bord-no">
					
					
					        <h4 class="pad-top">Peoples</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\people.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Photos</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\photos.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Science &amp; Medical</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\science-medical.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Security</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\security.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Seo Icons</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\seo.png">
					        <hr class="new-section-md bord-no">
					        ...
					        <img src="premium\icon-sets\thumbs\line-icons\sign-symbols.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Social Media</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\social-media.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Speech Bubbles</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\speech-bubbles.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Sports</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\sports.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Text</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\text.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Time</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\time.png">
					        <hr class="new-section-md bord-no">
					
					        <h4 class="pad-top">Touch Gestures</h4>
					        <img src="premium\icon-sets\thumbs\line-icons\touch.png">
					        <hr class="new-section-md bord-no">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
						                    <li class="active-link"><a href="premium-line-icons.html">Line Icons Pack</a></li>
