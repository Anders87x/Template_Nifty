...
<head>
    ...
    <title>Clipboard | Nifty - Admin Template</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Clipboard</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                ...
                <div id="page-content">
					        ...
					        <div class="col-sm-6">
					            ...
					            <div class="panel">
					                 <div class="panel-heading">
					                     <h3 class="panel-title">Copy text from another element</h3>
					                 </div>
					                 <div class="panel-body">
					                    ...
					                    <div class="input-group mar-btm">
					                         <input id="demo-clipboard-1" class="form-control" type="text" value="Lorem ipsum dolor sit amet, consectetuer adipiscing elit.">
					                         <span class="input-group-btn">
					                             <button class="btn btn-primary" type="button" data-clipboard-target="#demo-clipboard-1">Copy</button>
					                         </span>
					                     </div>
					                 </div>
					             </div>
					            ...
					            <div class="panel">
					                 <div class="panel-heading">
					                     <h3 class="panel-title">Cut text from another element</h3>
					                 </div>
					                 <div class="panel-body">
					                     ...
					                     <hr>
					                     <textarea id="demo-clipboard-2" placeholder="Message" rows="5" class="form-control">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness.</textarea>
					                     <br>
					                     <button class="btn btn-success" type="button" data-clipboard-action="cut" data-clipboard-target="#demo-clipboard-2">Cut to clipboard</button>
					                 </div>
					             </div>
					            <!---------------------------------->
					            ...
					            <div class="panel">
					                 <div class="panel-heading">
					                     <h3 class="panel-title">Copy text from attribute</h3>
					                 </div>
					                 <div class="panel-body">
					                     ...
					                     <button class="btn btn-purple" data-clipboard-text="The European languages are members of the same family. Their separate existence is a myth.">Copy to clipboard</button>
					                 </div>
					             </div>
					            <!---------------------------------->
					...
					<pre>var clipboard = new Clipboard('.btn');
...
clipboard.on('error', function(e) {
    ...
    console.error('Trigger:', e.trigger);
					            ...
					            <div class="panel">
					                 <div class="panel-heading">
					                     <h3 class="panel-title">Paste your copied text.</h3>
					                 </div>
					                 <div class="panel-body">
					                    <textarea class="form-control" placeholder="Paste and test you copied text." rows="7"></textarea>
					                 </div>
					             </div>
					            <!---------------------------------->
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="misc-clipboard.html">Clipboard</a></li>
