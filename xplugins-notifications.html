...
<head>
    ...
    <title>Notifications | Nifty - Admin Template</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Notifications</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					    ...
					    <div class="row">
					            ...
					            <div class="panel">
					                ...
					                <form class="form-horizontal" autocomplete="off">
					                    <div class="panel-body">
					                        <p class="text-bold text-uppercase text-main">Types</p>
					                        <div class="form-group">
					                            <label class="col-sm-4 control-label" for="demo-hor-inputemail">Layout</label>
					                            <div class="col-sm-8">
					                                <div class="select">
					                        ...
					                        <p class="text-bold text-uppercase text-main">Floating Options</p>
					
					                        <div class="form-group">
					                            <label class="col-sm-4 control-label demo-floating-label">Animation In</label>
					                            <div class="col-sm-8">
					                                <div class="select">
					                                    <select id="demo-alert-animin">
					                                        <optgroup label="Attention Seekers">
					                                            <option value="jellyIn" selected="">Jelly</option>
					                        ...
					                        <div class="form-group">
					                            <label class="col-sm-4 control-label demo-floating-label">Animation Out</label>
					                            <div class="col-sm-8">
					                                <div class="select">
					                                    <select id="demo-alert-animout">
					                                        <optgroup label="Attention Seekers">
					                                            <option value="bounce">bounce</option>
					                                            <option value="flash">flash</option>
					                                            <option value="pulse">pulse</option>
					                        ...
					                        <div class="form-group">
					                            <label class="col-sm-4 control-label demo-floating-label">Positions</label>
					                            <div class="col-sm-8">
					                                <div class="select">
					                                    <select id="demo-alert-pos">
					                                        <optgroup label="Top">
					                        ...
					                        <hr class="new-section-xs bord-no">
					                        <p class="text-bold text-uppercase text-main">Dismissable</p>
					
					                        <div class="row">
					                            <div class="col-md-6">
					                                <div class="form-group">
					                                    <label class="col-sm-8 control-label">Close Button</label>
					                                    <div class="col-sm-4">
					                                        <div class="pull-left">
					                                            <input id="demo-close-btn" class="toggle-switch" type="checkbox" checked="">
					                                            <label for="demo-close-btn"></label>
					                                        </div>
					                                    </div>
					                                </div>
					                            </div>
					                            <div class="col-md-6">
					                                <div class="form-group">
					                                    <label class="col-sm-8 control-label">Sticky Alert</label>
					                                    <div class="col-sm-4">
					                                        <div class="pull-left">
					                                            <input id="demo-sticky-alert" class="toggle-switch" type="checkbox">
					                                            <label for="demo-sticky-alert"></label>
					                                        </div>
					                                    </div>
					                                </div>
					                            </div>
					                        ...
					                        <button id="demo-add-alert" class="btn btn-lg btn-block btn-purple">Add an Alert</button>
					                    </div>
					                </form>
					            </div>
					        </div>
					        <div class="col-lg-8 col-sm-7">
					            <div class="panel">
					                ...
					                <div class="panel-body">
					                    <div id="demo-preview-alert" class="demo-preview-alert">
					            ...
					            <div class="panel">
					                ...
					                <!--Panel heading-->
					                <div class="panel-heading">
					                    <h3 class="panel-title">Notification Mode</h3>
					                </div>
					                <div class="panel-body">
					                    <div class="row">
					                        <div class="col-md-4">
					                            <a href="#" class="thumbnail demo-thumb-alert mar-no" style="opacity: 0.5; transition: all 0.5s ease 0s;">
					                                <img src="img\pg-alert.jpeg" alt="Page Alert">
					                                <span class="pad-ver box-block bg-dark text-center">
					                                    <span class="text-light text-semibold text-lg text-uppercase">Page <span class="hidden">page</span></span>
					                                </span>
					                            </a>
					                        </div>
					                        <div class="col-md-4">
					                            <a href="#" class="thumbnail demo-thumb-alert mar-no" style="opacity: 0.5; transition: all 0.5s ease 0s;">
					                                <img src="img\pl-alert.jpeg" alt="Panel Alert">
					                                <span class="pad-ver box-block bg-dark text-center">
					                                    <span class="text-light text-semibold text-lg text-uppercase">Custom (Panel) <span class="hidden">#demo-panel-alert</span></span>
					                                </span>
					                            </a>
					                        </div>
					                        <div class="col-md-4">
					                            <a href="#" class="thumbnail demo-thumb-alert selected mar-no">
					                                <img src="img\gl-alert.jpeg" alt="Grow like Alert">
					                                <span class="pad-ver box-block bg-dark text-center">
					                                    <span class="text-light text-semibold text-lg text-uppercase">Floating <span class="hidden">floating</span></span>
					                                </span>
					                            </a>
					                        </div>
					                    </div>
					    ...
					    <div id="demo-panel-alert" class="panel">
					        ...
					        <div class="panel-heading">
					            <div class="panel-control">
					                <button data-toggle="collapse" data-target="#demo-panel-collapse" class="btn btn-default" aria-expanded="true"><i class="demo-pli-arrow-down"></i></button>
					                <button data-dismiss="panel" class="btn btn-default"><i class="demo-pli-cross"></i></button>
					            </div>
					        ...
					        <div id="demo-panel-collapse" class="collapse in" aria-expanded="true" style="">
					            ...
					            <!-- Panel body -->
					            <div class="panel-body">
					                <h4>Show alerts on this panel.</h4>
					                <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
					            </div>
					        </div>
					    </div>
					
					    <hr class="new-section-md">
					    ...
					    <div class="row">
					        <div class="col-md-4">
					            <div class="panel">
					                ...
					                <div class="panel-body">
					                    <p>Notification class exposes a few events for hooking into alert functionality.</p>
					                    <div class="row mar-ver">
					                        <div class="col-xs-6 mar">
					                            <button id="demo-noty-onshow" class="btn btn-purple btn-block mar-btm">onShow</button>
					                            <button id="demo-noty-onshown" class="btn btn-danger btn-block">onShown</button>
					                        </div>
					                        <div class="col-xs-6">
					                            <button id="demo-noty-onhide" class="btn btn-warning btn-block mar-btm">onHide</button>
					                            <button id="demo-noty-onhidden" class="btn btn-info btn-block">onHidden</button>
					                        </div>
					            ...
					            <div class="panel">
					                <div class="panel-body">
					                    ...
					                    <table class="table table-bordered table-striped pad-ver mar-no">
					                        ...
					                        <tbody>
					                            <tr>
					                                <td class="text-lg"><span class="label label-purple">onShow</span></td>
					                                <td>This event fires immediately when the show instance method is called.</td>
					                            </tr>
					                            <tr>
					                                <td class="text-lg"><span class="label label-danger">onShown</span></td>
					                                <td>This event is fired when the modal has been made visible to the user (will wait for CSS transitions to complete).</td>
					                            </tr>
					                            <tr>
					                                <td class="text-lg"><span class="label label-warning">onHide</span></td>
					                                <td>This event is fired immediately when the hide instance method has been called.</td>
					                            </tr>
					                            <tr>
					                                <td class="text-lg"><span class="label label-info">onHidden</span></td>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="xplugins-notifications.html">Notifications<span class="label label-purple pull-right">Improved</span></a></li>
