...
<head>
    ...
    <title>X-Editable | Nifty - Admin Template</title>
    ...
    <link href="plugins\x-editable\inputs-ext\typeaheadjs\lib\typeahead.js-bootstrap.css" rel="stylesheet">


    <!--Address [ OPTIONAL ]-->
    <link href="plugins\x-editable\inputs-ext\address\address.css" rel="stylesheet">
...
<body>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">X-Editable</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					             ...
					             <div class="pad-btm form-inline">
					                <div class="row">
					                    ...
					                    <div class="col-sm-6 table-toolbar-right">
					                        ...
					                        <button id="demo-editable-enable" class="btn btn-purple">Enable / Disable</button>
					                    </div>
					                </div>
					            </div>
					            ...
					            <table id="demo-editable-table" class="table table-bordered">
					                <tbody>
					                    <tr>
					                        ...
					                        <td width="65%"><a href="#" id="demo-editable-username" data-type="text" data-pk="1" data-title="Enter username">superuser</a></td>
					                    </tr>
					                    <tr>
					                    ...
					                    <tr>
					                        ...
					                        <td><a href="#" id="demo-editable-sex" data-type="select" data-pk="1" data-value="" data-title="Select sex"></a></td>
					                    </tr>
					                    <tr>
					                        <td>Select, remote array, no buttons</td>
					                        <td><a href="#" id="demo-editable-group" data-type="select" data-pk="1" data-value="5" data-source="/groups" data-title="Select group">Admin</a></td>
					                    </tr>
					                    <tr>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="misc-x-editable.html">X-Editable</a></li>
    ...
    <script src="plugins\x-editable\inputs-ext\mockjax\jquery.mockjax.js"></script>
    ...
    <!--TypeaheadJS [ OPTIONAL ]-->
    <script src="plugins\x-editable\inputs-ext\typeaheadjs\lib\typeahead.js"></script>


    <!--TypeaheadJS [ OPTIONAL ]-->
    <script src="plugins\x-editable\inputs-ext\typeaheadjs\typeaheadjs.js"></script>


    <!--Address [ OPTIONAL ]-->
    <script src="plugins\x-editable\inputs-ext\address\address.js"></script>


    <!--X-editable Data [ SAMPLE ]-->
    <script src="js\demo\x-editable-data.js"></script>
