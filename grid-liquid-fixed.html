...
<head>
    ...
    <title>Liquid Fixed | Nifty - Admin Template</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Liquid Fixed</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					...
					<li class="active">Liquid Fixed</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                ...
                <div id="page-content">
					    ...
					    <div class="panel">
					        <div class="panel-body">
					            <h3>Liquid Fixed Layouts</h3>
					            <p>Below are liquid layouts where the layout spans the entire page width wise, expanding and contracting as the page is resized.</p>
					        </div>
					    </div>
					    ...
					    <div class="panel">
					        <div class="panel-heading">
					            <h3 class="panel-title">2 Column Layout</h3>
					        </div>
					        <div class="panel-body demo-liquid-fixed">
					            <h5>Left Fixed</h5>
					            <p>This is a two columns liquid layout with the left column being static, always in view.</p>
					            <div class="fixed-fluid">
					                <div class="fixed-sm-250 pull-sm-left">
					                    <strong class="text-uppercase">Left Column</strong><br> Fixed - 250px
					                </div>
					                <div class="fluid">
					                    <strong class="text-uppercase">Right Column</strong><br> Liquid
					                </div>
					            </div>
					            <hr>
					            <h5>Right Fixed</h5>
					            <p>Just change the <code>pull-left</code> class to <code>pull-right</code> without changing any code.</p>
					            <div class="fixed-fluid">
					                <div class="fixed-sm-250 pull-sm-right">
					                    <strong class="text-uppercase">Right Column</strong><br> Fixed - 250px
					                </div>
					                <div class="fluid">
					                    <strong class="text-uppercase">Left Column</strong><br> Liquid
					                </div>
					            </div>
					        </div>
					    </div>
					    ...
					    <div class="panel">
					        <div class="panel-heading">
					            <h3 class="panel-title">3 Column Layout</h3>
					        </div>
					        <div class="panel-body demo-liquid-fixed">
					            ...
					            <div class="fixed-fluid">
					                ...
					                <div class="fixed-sm-200 pull-sm-right">
					                    <strong class="text-uppercase">Right Column</strong><br> Fixed - 200px
					                </div>
					                <div class="fluid">
					                    <strong class="text-uppercase">Middle Column</strong><br> Liquid
					                </div>
					            </div>
					            ...
					            <div class="fixed-fluid">
					                ...
					                <div class="fixed-sm-200 pull-sm-left">
					                    <strong class="text-uppercase">Middle Column</strong><br> Fixed - 200px
					                </div>
					                <div class="fluid">
					                    <strong class="text-uppercase">Right Column</strong><br> Liquid
					                </div>
					    ...
					    <div class="panel">
					        <div class="panel-heading">
					            <h3 class="panel-title">4 Column Layout</h3>
					        </div>
					        <div class="panel-body demo-liquid-fixed">
					            <p>You can create layouts with any number of fixed and liquid/fluid columns.</p>
					            <hr>
					            <div class="fixed-fluid">
					                <div class="fixed-sm-160 pull-sm-left">
					                    <strong class="text-uppercase">Left Column</strong><br> Fixed - 160px
					                </div>
					                <div class="fixed-sm-160 pull-sm-left">
					                    <strong class="text-uppercase">Middle Column</strong><br> Fixed - 160px
					                </div>
					                <div class="fixed-sm-160 pull-sm-left">
					                    <strong class="text-uppercase">Right Column</strong><br> Fixed - 160px
					                </div>
					                <div class="fluid">
					                    <strong class="text-uppercase">Middle Column</strong><br> Liquid
					                </div>
					            ...
					            <hr>
					            <div class="fixed-fluid">
					                <div class="fixed-sm-160 pull-sm-right">
					                    <strong class="text-uppercase">Left Column</strong><br> Fixed - 160px
					                </div>
					                <div class="fixed-sm-160 pull-sm-right">
					                    <strong class="text-uppercase">Middle Column</strong><br> Fixed - 160px
					                ...
					                <thead>
					                    <tr>
					                        ...
					                        <th class="text-center">
					                            <div class="pad-all"><i class="demo-pli-smartphone-3 icon-3x"></i></div>
					                            Extra small devices<br>
					                            <small class="text-muted text-normal">Phones (&lt;768px)</small>
					                        </th>
					                        <th class="text-center">
					                            <div class="pad-all"><i class="demo-pli-tablet-2 icon-3x"></i></div>
					                            Small devices<br>
					                            <small class="text-muted text-normal">Tablets (≥768px)</small>
					                        </th>
					                        <th class="text-center">
					                            <div class="pad-all"><i class="demo-pli-laptop icon-3x"></i></div>
					                            Medium devices<br>
					                            <small class="text-muted text-normal">Desktops (≥992px)</small>
					                        </th>
					                        <th class="text-center">
					                            <div class="pad-all"><i class="demo-pli-monitor-2 icon-3x"></i></div>
					                            Large devices<br>
					                            <small class="text-muted text-normal">Desktops (≥1200px)</small>
					                        </th>
					                    </tr>
					                </thead>
					                <tbody>
					                    <tr>
					                        <td class="text-left">Fixed width 160px</td>
					                        <td><code>.fixed-xs-160</code></td>
					                        <td><code>.fixed-sm-160</code></td>
					                        <td><code>.fixed-md-160</code></td>
					                        <td><code>.fixed-lg-160</code></td>
					                    </tr>
					                    <tr>
					                        <td class="text-left">Fixed width 200px</td>
					                        <td><code>.fixed-xs-200</code></td>
					                        <td><code>.fixed-sm-200</code></td>
					                        <td><code>.fixed-md-200</code></td>
					                        <td><code>.fixed-lg-200</code></td>
					                    </tr>
					                    <tr>
					                        <td class="text-left">Fixed width 250px</td>
					                        <td><code>.fixed-xs-250</code></td>
					                        <td><code>.fixed-sm-250</code></td>
					                        <td><code>.fixed-md-250</code></td>
					                        <td><code>.fixed-lg-250</code></td>
					                    </tr>
					                    <tr>
					                        <td class="text-left">Fixed width 300px</td>
					                        <td><code>.fixed-xs-300</code></td>
					                        <td><code>.fixed-sm-300</code></td>
					                        <td><code>.fixed-md-300</code></td>
					                        <td><code>.fixed-lg-300</code></td>
					                    </tr>
					                    <tr>
					                        <td class="text-left">Fixed width 350px</td>
					                        <td><code>.fixed-xs-350</code></td>
					                        <td><code>.fixed-sm-350</code></td>
					                        <td><code>.fixed-md-350</code></td>
					                        <td><code>.fixed-lg-350</code></td>
					                    </tr>
					                    <tr>
					                        <td class="text-left">Force the column to the left.</td>
					                        <td><code>.pull-xs-left</code></td>
					                        <td><code>.pull-sm-left</code></td>
					                        <td><code>.pull-md-left</code></td>
					                        <td><code>.pull-lg-left</code></td>
					                    </tr>
					                    <tr>
					                        <td class="text-left">Force the column to the right.</td>
					                        <td><code>.pull-xs-right</code></td>
					                        <td><code>.pull-sm-right</code></td>
					                        <td><code>.pull-md-right</code></td>
					                        <td><code>.pull-lg-right</code></td>
					                    </tr>
					                </tbody>
					            </table>
					        </div>
					    ...
					    <div class="panel">
					        ...
					        <div class="panel-body demo-liquid-fixed">
					            <h5>Fixed Sizes</h5>
					            <p>Fixed column will be resized for each device.</p>
					            <div class="fixed-fluid">
					                <div class="fixed-sm-160 fixed-md-200 fixed-lg-350 pull-sm-left">
					                    <strong class="text-uppercase">Fixed Left Column</strong>
					                    <table class="mar-top">
					                        <thead>
					                            <tr>
					                                <th>Device</th>
					                        ...
					                        <tbody>
					                            <tr class="mar-top">
					                                <td style="width:150px;">
					                                    <span class="text-main">Large devices</span>
					                                </td>
					                                <td class="text-center">350px</td>
					                            </tr>
					                            <tr>
					                                <td>
					                                    <span class="text-main">Medium devices</span>
					                                </td>
					                                <td class="text-center">200px</td>
					                            </tr>
					                            <tr>
					                                <td>
					                                    <span class="text-main">Small devices</span>
					                                </td>
					                                <td class="text-center">160px</td>
					                            </tr>
					                            <tr>
					                                <td>
					                                    <span class="text-main">Extra Small devices</span>
					                                </td>
					            ...
					            <hr>
					            <h5>Shifting columns.</h5>
					            <p>The fixed column moves to the left on the medium device and returns to the right on the small device.</p>
					            <div class="fixed-fluid">
					                <div class="fixed-sm-250 pull-sm-right pull-md-left pull-lg-right">
					                    <strong class="text-uppercase">Fixed Column</strong>
					                    <table class="mar-top">
					                        <thead>
					                            <tr>
					                                <th>Device</th>
					                ...
					                <div class="fluid">
					                    <strong class="text-uppercase">Liquid Column</strong>
					                </div>
					            </div>
					
					            <hr>
					            <h5>Hide columns.</h5>
					            <p>On medium devices the fixed column will be hidden.</p>
					            <div class="fixed-fluid">
					                <div class="fixed-sm-250 hidden-md pull-sm-left">
					                    <strong class="text-uppercase">Fixed Column</strong>
					                    <table class="mar-top">
					                        <thead>
					                            <tr>
					                                <th>Device</th>
					                                <th class="text-center" style="width:100px">Hidden</th>
					                            </tr>
					                        </thead>
					                        <tbody>
					                            <tr>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="grid-liquid-fixed.html">Liquid Fixed</a></li>
