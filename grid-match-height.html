...
<head>
    ...
    <title>Match Height | Nifty - Admin Template</title>
...
<body>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Match Height</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					...
					<li class="active">Match Height</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                ...
                <div id="page-content">
					    ...
					    <div class="panel">
					        <div class="panel-body">
					            <h3>Match Height</h3>
					            <p>matchHeight makes the height of all selected elements exactly equal. It handles many edge cases that cause similar plugins to fail.</p>
					        </div>
					    </div>
					    ...
					    <h4 class="text-normal">Match Height by Row</h4>
					    <p class="mar-btm">You can toggle row detection by setting the <code>byRow</code> option, which defaults to true.</p>
					    <div class="row demo-mh-byrow">
					        <div class="col-md-5">
					            <div class="panel panel-dark panel-colorful">
					                <div class="panel-heading">
					                    <h3 class="panel-title">Far far away</h3>
					                </div>
					                <div class="pad-all">
					        ...
					        <div class="col-md-3">
					            <div class="panel bg-pink">
					                <div class="pad-all text-center">
					                    <span class="text-4x text-thin">32</span>
					                    <p>Projects</p>
					        ...
					        <div class="col-md-4">
					            <div class="panel panel-info panel-colorful">
					                <div class="panel-body text-center">
					                    ...
					                    <button class="btn btn-info mar-ver"><i class="demo-pli-male icon-fw"></i>Follow</button>
					    ...
					    <!---------------------------------->
					    <hr class="new-section-md">
					    <h4 class="text-normal">Specific Target</h4>
					    <p class="mar-btm">use the maximum height or define a specific target element.</p>
					    <div class="row">
					        <div class="col-md-6">
					            <div id="demo-mh-target" class="panel">
					                <div class="panel-heading">
					                    <h3 class="panel-title">The European languages</h3>
					                </div>
					                <div class="pad-all">
					                    <img class="img-responsive" src="img\shared-img.jpeg" alt="Image">
					                    <p class="pad-top">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
					        ...
					        <div class="col-md-6">
					            <div id="demo-mh-box" class="panel panel-mints panel-colorful">
					                <div class="panel-body">
					                    <div class="row demo-mh-byrow">
					                        <div class="col-md-6">
					    ...
					    <!-- Match Height - data-match-height -->
					    <!---------------------------------->
					    <hr class="new-section-md">
					    <h4 class="text-normal">data-match-height</h4>
					    <p class="mar-btm">Use the data attribute <code>data-match-height="group-name"</code> where <code>group-name</code> is an arbitrary string to identify which elements should be considered as a group.</p>
					    <div class="row demo-mh-byrow">
					        <div class="col-md-3">
					            <div class="panel panel-success panel-colorful" data-match-height="items-a">
					                <div class="panel-heading">
					                    <h3 class="panel-title">data-match-height="items-a"</h3>
					                </div>
					                <div class="pad-all">
					                    <p>The European languages are members of the same family. Their separate existence is a myth. For science, music, sport, etc, Europe uses the same vocabulary.</p>
					                </div>
					        ...
					        <div class="col-md-3">
					            <div class="panel panel-dark panel-colorful" data-match-height="items-b">
					                <div class="panel-heading">
					                    <h3 class="panel-title">data-match-height="items-b"</h3>
					                </div>
					                <div class="pad-all">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="grid-match-height.html">Match Height</a></li>
    ...
    <script src="plugins\jquery-match-height\jquery-match-height.min.js"></script>
    ...
    <script>
        $(document).on('nifty.ready', function () {
			...
			// Apply matchHeight using target
			// =================================================================
			// Require matchHeight
			// =================================================================
			$('#demo-mh-box').matchHeight({
			    target: $('#demo-mh-target')
			});
