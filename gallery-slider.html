...
<head>
    ...
    <title>Slider | Nifty - Admin Template</title>
...
<body>
                ...
                <div id="page-content">
					...
					<div class="row">
					    ...
					    <div class="col-lg-6">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Fade transition</h3>
					            </div>
					            <div class="pad-all">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="list-divider"></li>
											<li class="active-link"><a href="gallery-slider.html">Slider</a></li>
	...
	<script src="plugins\unitegallery\themes\slider\ug-theme-slider.js"></script>
