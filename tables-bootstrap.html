...
<body>
                ...
                <div id="page-content">
					...
					<div class="panel">
					    ...
					    <div class="panel-body">
					        <table data-toggle="table" data-url="data/bs-table.json" data-show-columns="true" data-page-list="[5, 10, 20]" data-page-size="5" data-pagination="true" data-show-pagination-switch="true">
					            <thead>
					                <tr>
					...
					<div class="row">
					    <div class="col-md-6">
					        <div class="panel">
					            ...
					            <div class="panel-body">
					                <table class="demo-add-niftycheck" data-toggle="table" data-url="data/bs-table-simple.json" data-page-size="10" data-pagination="true">
					                    <thead>
					                        <tr>
					    ...
					    <div class="col-md-6">
					        <div class="panel">
					            ...
					            <div class="panel-body">
					                <table class="demo-add-niftyradio" data-toggle="table" data-url="data/bs-table-simple.json" data-page-size="10" data-pagination="true">
					                    <thead>
					                        <tr>
					...
					<div class="panel">
					    ...
					    <div class="panel-body">
					        <table data-toggle="table" data-url="data/bs-table.json" data-sort-name="id" data-page-list="[5, 10, 20]" data-page-size="5" data-pagination="true" data-show-pagination-switch="true">
					            <thead>
					                <tr>
					...
					<div class="panel">
					    ...
					    <div class="panel-body">
					        <table data-toggle="table" data-url="data/bs-table.json" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-sort-name="id" data-page-list="[5, 10, 20]" data-page-size="5" data-pagination="true" data-show-pagination-switch="true">
					            <thead>
					                <tr>
					                    <th data-field="id" data-sortable="true" data-formatter="invoiceFormatter">ID</th>
					                    <th data-field="name" data-sortable="true">Name</th>
					...
					<div class="panel">
					    ...
					    <div class="panel-body">
					        ...
					        <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table" data-url="data/bs-table.json" data-toolbar="#demo-delete-row" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-sort-name="id" data-page-list="[5, 10, 20]" data-page-size="5" data-pagination="true" data-show-pagination-switch="true">
					            <thead>
					                <tr>
					...
					<div class="panel">
					    ...
					    <div class="panel-body">
					        <table id="demo-editable" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-sort-name="id" data-page-list="[5, 10, 20]" data-page-size="10" data-pagination="true" data-show-pagination-switch="true">
					        </table>
					    </div>
					</div>
    ...
    <script src="js\demo\tables-bs-table.js"></script>
