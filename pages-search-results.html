...
<head>
    ...
    <title>Search Results | Nifty - Admin Template</title>
...
<body>
    ...
    <div id="page-title">
        <h1 class="page-header text-overflow">Search Page</h1>
    </div>
    <hr class="bord-no">
					    ...
					    <div class="panel">
					        <div class="panel-body">
					            <div class="pad-hor mar-top">
					                <h2 class="text-thin mar-no">160 results found for: <i class="text-info text-normal">"Dashboard Theme"</i></h2>
					            ...
					            <ul class="list-group bord-no">
					                <li class="list-group-item list-item-lg">
					                    <div class="media-heading mar-no">
					                        <a class="btn-link text-lg text-semibold" href="#">Nifty - Responsive Admin Template</a>
					                    </div>
					                ...
					                <li class="list-group-item list-item-lg media">
					                    <div class="pull-left">
					                        <img class="img-lg" alt="Image" src="img\thumbs\img2.jpeg">
					                    </div>
					                    <div class="media-body">
					                        <div class="media-heading mar-no">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="pages-search-results.html">Search Results</a></li>
