...
<head>
    ...
    <title>Frequently Asked Questions | Nifty - Admin Template</title>
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <div class="text-center pad-btm">
                        ...
                        <button type="button" class="btn btn-success">Email us your question</button>
                        <button type="button" class="btn btn-primary">Send us a tweet</button>
                    </div>
                    </div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="pages-faq.html">FAQ</a></li>
