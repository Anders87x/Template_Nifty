...
<head>
    ...
    <title>Nestable List | Nifty - Admin Template</title>
    ...
    <link href="plugins\nestable-list\nestable-list.min.css" rel="stylesheet">
...
<body>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Nestable List</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                ...
                <div id="page-content">
					...
					<div class="panel">
					    <div class="panel-body">
					        <p class="mar-no">Drag &amp; drop hierarchical list with mouse and touch compatibility</p>
					    </div>
					</div>
					...
					<div class="panel">
					    <div class="panel-heading">
					        <h3 class="panel-title">Basic List</h3>
					    </div>
					    <div class="panel-body">
					        <div class="row">
					            <div class="col-md-6">
					                <div id="demo-nestable" class="dd">
					                    <ol class="dd-list">
					                        <li class="dd-item" data-id="Item 1">
					                            <div class="dd-handle dd-bg dd-anim">Item 1</div>
					                        </li>
					                        <li class="dd-item" data-id="Item 2">
					                            <div class="dd-handle dd-bg dd-anim">Item 2</div>
					                            <ol class="dd-list">
					                                <li class="dd-item" data-id="Item 3"><div class="dd-handle dd-bg dd-anim">Item 3</div></li>
					                                <li class="dd-item" data-id="Item 4"><div class="dd-handle dd-bg dd-anim">Item 4</div></li>
					                            </ol>
					                        </li>
					                        <li class="dd-item" data-id="Item 5"><div class="dd-handle dd-bg dd-anim">Item 5</div></li>
					                        <li class="dd-item" data-id="Item 6">
					                            <div class="dd-handle dd-bg dd-anim">Item 6</div>
					                            <ol class="dd-list">
					
					                                <li class="dd-item" data-id="Item 7">
					                                    <div class="dd-handle dd-bg dd-anim">Item 7</div>
					                                    <ol class="dd-list">
					                                        <li class="dd-item" data-id="Item 8"><div class="dd-handle dd-bg dd-anim">Item 8</div></li>
					                                        <li class="dd-item" data-id="Item 9"><div class="dd-handle dd-bg dd-anim">Item 9</div></li>
					                                    </ol>
					                                </li>
					                            </ol>
					                        </li>
					                        <li class="dd-item" data-id="Item 10"><div class="dd-handle dd-bg dd-anim">Item 10</div></li>
					                    </ol>
					                </div>
					            </div>
					            <div class="col-md-6">
					                <p class="text-main text-bold">Serialised Output</p>
					                <textarea id="demo-nestable-output" class="form-control mar-btm" rows="5" readonly=""></textarea>
					
					                <p class="text-main text-bold">Logs</p>
					                <textarea id="demo-nestable-logs" class="form-control" rows="7" readonly=""></textarea>
					            </div>
					        </div>
					    </div>
					</div>
					...
					<div class="panel">
					    <div class="panel-heading">
					        <h3 class="panel-title">Mutliple List</h3>
					    </div>
					    <div class="panel-body">
					        <div class="row">
					            <div class="col-sm-5">
					                <div class="bord-all pad-all mar-btm">
					                    <div id="demo-nestable-multi-1" class="dd">
					                        <ol class="dd-list">
					                            <li class="dd-item" data-id="Item 1">
					                                <div class="dd-handle dd-bg dd-anim">Item 1</div>
					                            </li>
					                ...
					                <p class="text-main text-bold">Serialised Output</p>
					                <textarea id="demo-nestable-multi-1-output" class="form-control mar-btm" rows="5" readonly=""></textarea>
					            </div>
					            <div class="col-sm-2">
					                <div class="row text-center mar-top pad-all">
					                    <div class="col-xs-6"><i class="demo-psi-arrow-left icon-2x"></i></div>
					                    <div class="col-xs-6"><i class="demo-psi-arrow-right icon-2x"></i></div>
					                </div>
					            </div>
					            <div class="col-sm-5">
					                <div class="bord-all pad-all mar-btm">
					                    <div id="demo-nestable-multi-2" class="dd">
					                        <ol class="dd-list">
					                            <li class="dd-item" data-id="Item 6">
					                                <div class="dd-handle dd-bg dd-anim">Item 6</div>
					                                <ol class="dd-list">
					                ...
					                <hr class="new-section-sm bord-no">
					                <p class="text-main text-bold">Serialised Output</p>
					                <textarea id="demo-nestable-multi-2-output" class="form-control mar-btm" rows="5" readonly=""></textarea>
					            </div>
					        </div>
					    </div>
					</div>
					...
					<div class="panel">
					    <div class="panel-heading">
					        <h3 class="panel-title">Draggable Handles</h3>
					    </div>
					    <div class="panel-body">
					        <div class="row">
					            <div class="col-md-6">
					                ...
					                <br>
					                <div id="demo-nestable-handler" class="dd">
					                    <ol class="dd-list dd-list-handle-btn">
					                        <li class="dd-item" data-id="Item 1">
					                            <div class="dd-handle dd-handle-btn"></div>
					                            <div class="dd-content bord-all">Item 1</div>
					                        </li>
					                        <li class="dd-item" data-id="Item 2">
					                            <div class="dd-handle dd-handle-btn"></div>
					                            <div class="dd-content bord-all">Item 2</div>
					                            <ol class="dd-list">
					                                <li class="dd-item" data-id="Item 3">
					                                    <div class="dd-handle dd-handle-btn"></div>
					                                    <div class="dd-content bord-all">Item 3</div>
					                                </li>
					                                <li class="dd-item" data-id="Item 4">
					                                    <div class="dd-handle dd-handle-btn"></div>
					                                    <div class="dd-content bord-all">Item 4</div>
					                                </li>
					                            </ol>
					                        </li>
					                        <li class="dd-item" data-id="Item 5">
					                            <div class="dd-handle dd-handle-btn"></div>
					                            <div class="dd-content bord-all">Item 5</div>
					                        </li>
					                        <li class="dd-item" data-id="Item 6">
					                            <div class="dd-handle dd-handle-btn"></div>
					                            <div class="dd-content bord-all">Item 6</div>
					                            <ol class="dd-list">
					                                <li class="dd-item" data-id="Item 7">
					                                    <div class="dd-handle dd-handle-btn"></div>
					                                    <div class="dd-content bord-all">Item 7</div>
					                                    <ol class="dd-list">
					                                        <li class="dd-item" data-id="Item 8">
					                                            <div class="dd-handle dd-handle-btn"></div>
					                                            <div class="dd-content bord-all">Item 8</div>
					                                        </li>
					                                        <li class="dd-item" data-id="Item 9">
					                                            <div class="dd-handle dd-handle-btn"></div>
					                                            <div class="dd-content bord-all">Item 9</div>
					                                        </li>
					                                    </ol>
					                                </li>
					                            </ol>
					                        </li>
					                        <li class="dd-item" data-id="Item 10">
					                            <div class="dd-handle dd-handle-btn"></div>
					                            <div class="dd-content bord-all">Item 10</div>
					                        </li>
					                    </ol>
					                </div>
					            </div>
					            <div class="col-md-6">
					                <p class="text-main text-bold">Serialised Output</p>
					                <textarea id="demo-nestable-handler-output" class="form-control mar-btm" rows="5" readonly=""></textarea>
					                <p class="text-main text-bold">Logs</p>
					                <textarea id="demo-nestable-handler-logs" class="form-control" rows="7" readonly=""></textarea>
					            </div>
					        </div>
					    </div>
					</div>
					...
					<div class="panel">
					    <div class="panel-heading">
					        <h3 class="panel-title">Custom Theme List</h3>
					    </div>
					    <div class="panel-body">
					        <div class="row">
					            <div class="col-md-3">
					                <div id="demo-nestable-theme-4" class="dd">
					                    <ol class="dd-list">
					                        <li class="dd-item" data-id="Item 1">
					                            <div class="dd-handle dd-dashed">
					                                <span class="pull-right badge badge-success badge-icon">9</span>
					                                Item 1
					                            </div>
					                        </li>
					                        <li class="dd-item" data-id="Item 2">
					                            <div class="dd-handle dd-dashed">
					                                <i class="pull-right text-muted"><small>Today</small></i>
					                                Item 2
					                            </div>
					                            <ol class="dd-list">
					                                <li class="dd-item" data-id="Item 3">
					                                    <div class="dd-handle dd-dashed">
					                                        <i class="pull-right text-sm text-muted text-semibold"><small>12:30AM</small></i>
					                                        Item 3
					                                    </div>
					                                </li>
					                                <li class="dd-item" data-id="Item 4">
					                                    <div class="dd-handle dd-dashed">
					                                        <i class="pull-right text-sm text-muted text-semibold"><mark>2 Hours ago</mark></i>
					                                        Item 4
					                                    </div>
					                                </li>
					                            </ol>
					                        ...
					                        <li class="dd-item" data-id="Item 5">
					                            <div class="dd-handle dd-dashed">
					                                <i class="pull-right demo-psi-heart-2 icon-lg text-pink"></i>
					                                Item 5
					                            </div>
					                        </li>
					                        <li class="dd-item" data-id="Item 6">
					                            <div class="dd-handle dd-dashed">
					                                <span class="label label-danger pull-right">Feature</span>
					                                Item 6
					                            </div>
					                        </li>
					                    </ol>
					                    ...
					                    <ol class="dd-list">
					                        <li class="dd-item" data-id="Item 1">
					                            <div class="dd-handle dd-outline dd-anim">
					                                ...
					                                <div class="media-body">
					                                    <div class="text-semibold text-nowrap">People</div>
					                            ...
					                            <ol class="dd-list">
					                                <li class="dd-item" data-id="Item 3">
					                                    <div class="dd-handle dd-outline dd-anim">
					                                        ...
					                                        <div class="media-body">
					                                            <p class="text-semibold mar-no">Location</p>
					                                            <small class="text-muted">This is the item description</small>
					                                        </div>
					                                    </div>
					                                </li>
					                        ...
					                        <li class="dd-item" data-id="Item 6">
					                            <div class="dd-handle dd-outline dd-anim">
					                                ...
					                                <div class="media-body">
					                                    <p class="text-semibold mar-no">Security</p>
					                                    <small class="text-muted">This is the item description</small>
					                                </div>
					                            </div>
					                        </li>
					            ...
					            <div class="col-md-3">
					                <div id="demo-nestable-theme-3" class="dd">
					                    <ol class="dd-list">
					                        <li class="dd-item" data-id="Item 1">
					                            <div class="dd-handle dd-dashed">
					                                <span class="badge badge-success badge-icon badge-fw"></span>
					                                Item 1
					                            </div>
					                        </li>
					                        <li class="dd-item" data-id="Item 2">
					                            <div class="dd-handle dd-dashed">
					                                <span class="badge badge-purple badge-icon badge-fw"></span>
					                                Item 2
					                            </div>
					                            <ol class="dd-list">
					                                <li class="dd-item" data-id="Item 3">
					                                    <div class="dd-handle dd-dashed">
					                                        <span class="badge badge-warning badge-icon badge-fw"></span>
					                                        Item 3
					                                    </div>
					                                </li>
					                                <li class="dd-item" data-id="Item 4">
					                                    <div class="dd-handle dd-dashed">
					                                        <span class="badge badge-mint badge-icon badge-fw"></span>
					                                        Item 4
					                                    </div>
					                                </li>
					                            </ol>
					                        ...
					                        <li class="dd-item" data-id="Item 5">
					                            <div class="dd-handle dd-dashed">
					                                <span class="badge badge-primary badge-icon badge-fw"></span>
					                                Item 5
					                            </div>
					                        </li>
					                        <li class="dd-item" data-id="Item 6">
					                            <div class="dd-handle dd-dashed">
					                                <span class="badge badge-danger badge-icon badge-fw"></span>
					                                Item 6
					                            </div>
					                        </li>
					                    </ol>
					            ...
					            <div class="col-md-3">
					                <div id="demo-nestable-theme-1" class="dd">
					                    <ol class="dd-list">
					                        <li class="dd-item" data-id="Item 1">
					                            <div class="dd-handle">
					                                <i class="demo-pli-camera-2 icon-lg"></i>
					                                Item 1
					                            </div>
					                        </li>
					                        <li class="dd-item" data-id="Item 2">
					                            <div class="dd-handle">
					                                <i class="demo-pli-file-zip icon-lg"></i>
					                                Item 2
					                            </div>
					                            <ol class="dd-list">
					                                <li class="dd-item" data-id="Item 3">
					                                    <div class="dd-handle">
					                                        <i class="demo-pli-video icon-lg"></i>
					                                        Item 3
					                                    </div>
					                                </li>
					                                <li class="dd-item" data-id="Item 4">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="misc-nestable-list.html">Nestable List</a></li>
    ...
    <!--Nestable List [ OPTIONAL ]-->
    <script src="plugins\nestable-list\jquery.nestable.js"></script>
